  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><router-link to="/" class="nav-link scrollto active" href="#hero">Home</router-link></li>
          <li><router-link to="/" class="nav-link scrollto" href="#services">Services</router-link></li>
